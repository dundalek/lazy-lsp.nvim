...
| [eslint](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#eslint) | [nodePackages.eslint](https://search.nixos.org/packages?channel=unstable&query=nodePackages.eslint&show=nodePackages.eslint) |
...
| [gdscript](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#gdscript) | [godot](https://search.nixos.org/packages?channel=unstable&query=godot&show=godot) |
...
| [stylelint_lsp](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#stylelint_lsp) | [nodePackages.stylelint](https://search.nixos.org/packages?channel=unstable&query=nodePackages.stylelint&show=nodePackages.stylelint) |
| [sumneko_lua](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#sumneko_lua) | [sumneko-lua-language-server](https://search.nixos.org/packages?channel=unstable&query=sumneko-lua-language-server&show=sumneko-lua-language-server) |
...
- [arduino_language_server](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#arduino_language_server)
...
- [fortls](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#fortls)
...
- [ltex](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#ltex)
...
- [nickel_ls](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#nickel_ls)
...
- [prismals](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#prismals)
...
- [quick_lint_js](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#quick_lint_js)
...
- [rome](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#rome)
...
- [solc](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#solc)
...
- [teal_ls](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#teal_ls)
- [theme_check](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#theme_check)
- [tilt_ls](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#tilt_ls)
...
- [verible](https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md#verible)
